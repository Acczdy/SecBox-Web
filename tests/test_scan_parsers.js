...
assert.strictEqual(result.data.aliveHosts.length, 1);
assert.strictEqual(result.data.aliveHosts[0], '192.168.88.10');
assert(result.sectionsHtml.includes('ICMP 存活主机'));
assert(!result.sectionsHtml.includes('未识别行（1 条'));
